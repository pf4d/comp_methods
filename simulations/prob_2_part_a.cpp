...
int main()
{
	...
	for (unsigned int i = 0; i < n_a.size(); i++)
	{
		...
		ofstream x_file ("../data/a/x_" + to_string(n) + ".txt");
		ofstream u_file ("../data/a/u_" + to_string(n) + ".txt");
	...
	// output the vectors to files for later plotting :
	ofstream n_file ("../data/a/n.txt");
	ofstream e_file ("../data/a/e.txt");
	ofstream i_file ("../data/a/i.txt");
	ofstream t_file ("../data/a/t.txt");
